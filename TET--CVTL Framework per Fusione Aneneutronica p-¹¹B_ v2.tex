...
Il vero potenziale del Concept 2 emerge nell'integrazione diretta con il motore a torque dal vuoto puro (Concept 3), creando un ciclo ibrido auto-sostenuto che elimina progressivamente la dipendenza da propellente trasportato. Le particelle $\alpha$ prodotte dalla fusione catalizzata (8.7 MeV totali, energia cinetica media ~2.9 MeV per particella, velocità ~1.6 × 10^7 m/s) non sono solo il prodotto utile per propulsione impulsiva o applicazioni mediche, ma fungono da sorgente energetica diretta per il braiding drive nei convertitori MZMs.
